...
Label(r"${\mathbf v}$", v, alignment="lt", offset=[4,-4]).draw()
Label(r"${\mathbf sv}$", proj, alignment="lt", offset=[4,-4]).draw()
Label(r"${\mathbf w-sv}$", smult(0.5,vsum(proj,w)),
      alignment="lc", offset=[4,4]).draw() 
Label(r"${\mathbf w}$", w, alignment="rb", offset=[-4,4]).draw()
...
#Label(r"${\mathbf v}$", v, alignment="lt", offset=[4,-4]).draw()
Label(r"${\mathbf z}$", proj, alignment="lt", offset=[4,-4]).draw()
Label(r"${\mathbf y}$", y, alignment="lt", offset=[4,-4]).draw() 
Label(r"${\mathbf w}$", w, alignment="rb", offset=[-4,4]).draw()
Label(r"$L$", [5,2.5], alignment="rb", offset=[-4,4]).draw()
...
#Label(r"${\mathbf y}$", y, alignment="lt", offset=[4,-4]).draw() 
Label(r"${\mathbf w}$", w, alignment="rb", offset=[-4,4]).draw()
Label(r"${\mathbf w-z}$", smult(0.5,vsum(proj,w)),
      alignment="lc", offset=[4,4]).draw() 
Label(r"$L$", [5,2.5], alignment="rb", offset=[-4,4]).draw()

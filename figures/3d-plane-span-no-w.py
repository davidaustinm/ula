...
Label(r'${\mathbf v}_1$', e1, alignment="lt", offset=[dx,-2]).draw()
Label(r'${\mathbf v}_2$', e2, alignment="rb", offset=[-dx,5]).draw()
Label(r'${\mathbf v}_3$', b, alignment="rt", offset=[-dx,-5]).draw()

...
sc = 1
Label(r'${\mathbf e}_1$', e1, alignment='lb', offset=[3,3],
      scale=sc).draw()
Label(r'${\mathbf e}_2$', e2, alignment='lb', offset=[3,3],
      scale=sc).draw()
Label(r'${\mathbf v}$', u, alignment='rb', offset=[-3,3],
      scale=sc).draw()
#Label(r'$T({\mathbf v})$', Tu, alignment='rb', offset=[-3,3]).draw()
